...
const server = http.createServer((req, res) => {
  ...
  const rewrites = {
    ...
    '/admin/menu':               '/admin/menu-management.html',
    '/admin/qr':                 '/admin/qr.html',
    '/admin/payments':           '/admin/payments.html',
    '/admin/loyalty':            '/admin/loyalty.html',
    '/restaurant':               '/restaurant/index.html',
    '/restaurant/menu':          '/restaurant/menu.html',
    '/restaurant/theme':         '/restaurant/theme.html',
    '/restaurant/live-ops':      '/restaurant/live-ops.html',
    '/restaurant/tables':        '/restaurant/tables.html',
    '/restaurant/reports':       '/restaurant/reports.html',
    '/restaurant/staff':         '/restaurant/staff.html',
    '/restaurant/subscription':  '/restaurant/subscription.html',
    '/restaurant/qr':            '/restaurant/qr.html',
    '/restaurant/billing':       '/restaurant/billing.html',
    '/restaurant/kitchen':       '/restaurant/kitchen.html',
    '/restaurant/waiter':        '/restaurant/waiter.html',
    '/restaurant/loyalty-crm':   '/restaurant/loyalty-crm.html',
    '/loyalty':                  '/loyalty/index.html',
    '/loyalty/dashboard':        '/loyalty/dashboard.html',
    '/loyalty/redeem':           '/loyalty/redeem.html',
    '/loyalty/photobooth':       '/loyalty/photobooth.html',
